...
class FAO_PET():
    ...
    def __init__(self, basin_id, nldas_forcing)-> None:

        self.conversions_m_to_mm = 1000
        self.conversions_hr_to_sec = 3600
        self.conversions_to_kilo = 1000
        ...
        camels_attr_file = "G:\Shared drives\SI_NextGen_Aridity\dCFE\data\camels_attributes_concat.csv"
        basin_attrs = pd.read_csv(camels_attr_file)
    ...
    def calc_PET(self):
        ...
        PET = PET.fillna(0)
        PET = PET / self.conversions_m_to_mm / self.conversions_hr_to_sec  #mm/hr to m/hr  to m/s
    ...
    def prepare_input(self, df):
        ...
        df["e_a"] = df.apply(self.calculate_actual_vapor_pressure_Pa, axis=1) / self.conversions_to_kilo
        ...
        df['P'] = df["pressure"] / self.conversions_to_kilo
